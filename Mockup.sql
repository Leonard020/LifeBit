...
-- 관리자
('admin@lifebit.com', crypt('password123', gen_salt('bf')), 'Admin', 175.5, 70.0, 30, 'male', 'ADMIN'),

-- 일반 사용자 49명 (현실적인 한국인 체형 데이터)
('user001@example.com', crypt('password123', gen_salt('bf')), 'MinSoo_Kim', 180.0, 75.0, 25, 'male', 'USER'),
('user002@example.com', crypt('password123', gen_salt('bf')), 'YoungHee_Lee', 165.0, 55.0, 26, 'female', 'USER'),
('user003@example.com', crypt('password123', gen_salt('bf')), 'ChulSoo_Park', 170.0, 65.0, 28, 'male', 'USER'),
('user004@example.com', crypt('password123', gen_salt('bf')), 'JiMin_Jung', 162.0, 52.0, 24, 'female', 'USER'),
('user005@example.com', crypt('password123', gen_salt('bf')), 'DongWook_Choi', 178.0, 72.0, 27, 'male', 'USER'),
('user006@example.com', crypt('password123', gen_salt('bf')), 'SoYoung_Han', 168.0, 58.0, 23, 'female', 'USER'),
('user007@example.com', crypt('password123', gen_salt('bf')), 'DaeHyun_Yoon', 175.0, 68.0, 29, 'male', 'USER'),
('user008@example.com', crypt('password123', gen_salt('bf')), 'MiKyung_Oh', 160.0, 50.0, 25, 'female', 'USER'),
('user009@example.com', crypt('password123', gen_salt('bf')), 'JunHo_Jang', 182.0, 80.0, 31, 'male', 'USER'),
('user010@example.com', crypt('password123', gen_salt('bf')), 'HyeWon_Shin', 167.0, 57.0, 27, 'female', 'USER'),
('user011@example.com', crypt('password123', gen_salt('bf')), 'TaeHyun_Song', 173.0, 70.0, 26, 'male', 'USER'),
('user012@example.com', crypt('password123', gen_salt('bf')), 'EunJung_Ryu', 164.0, 54.0, 24, 'female', 'USER'),
('user013@example.com', crypt('password123', gen_salt('bf')), 'JungMin_Ko', 176.0, 73.0, 28, 'male', 'USER'),
('user014@example.com', crypt('password123', gen_salt('bf')), 'SuJin_Lim', 161.0, 51.0, 22, 'female', 'USER'),
('user015@example.com', crypt('password123', gen_salt('bf')), 'YoungSoo_Jun', 179.0, 76.0, 30, 'male', 'USER'),
('user016@example.com', crypt('password123', gen_salt('bf')), 'SeoYeon_Baek', 166.0, 56.0, 25, 'female', 'USER'),
('user017@example.com', crypt('password123', gen_salt('bf')), 'HyunWoo_Jo', 174.0, 69.0, 27, 'male', 'USER'),
('user018@example.com', crypt('password123', gen_salt('bf')), 'MiRae_Kang', 163.0, 53.0, 23, 'female', 'USER'),
('user019@example.com', crypt('password123', gen_salt('bf')), 'JiHoon_Yang', 181.0, 78.0, 29, 'male', 'USER'),
('user020@example.com', crypt('password123', gen_salt('bf')), 'YuNa_Seo', 169.0, 59.0, 26, 'female', 'USER'),
('user021@example.com', crypt('password123', gen_salt('bf')), 'SungHo_Moon', 177.0, 74.0, 28, 'male', 'USER'),
('user022@example.com', crypt('password123', gen_salt('bf')), 'DaEun_Yu', 165.0, 55.0, 24, 'female', 'USER'),
('user023@example.com', crypt('password123', gen_salt('bf')), 'JaeWon_Sim', 172.0, 67.0, 25, 'male', 'USER'),
('user024@example.com', crypt('password123', gen_salt('bf')), 'YeJin_Noh', 162.0, 52.0, 23, 'female', 'USER'),
('user025@example.com', crypt('password123', gen_salt('bf')), 'JunSeok_Heo', 178.0, 75.0, 27, 'male', 'USER'),
('user026@example.com', crypt('password123', gen_salt('bf')), 'ChaeWon_Nam', 167.0, 57.0, 25, 'female', 'USER'),
('user027@example.com', crypt('password123', gen_salt('bf')), 'DoYoung_Hwang', 175.0, 71.0, 26, 'male', 'USER'),
('user028@example.com', crypt('password123', gen_salt('bf')), 'SeoHyun_Kong', 164.0, 54.0, 24, 'female', 'USER'),
('user029@example.com', crypt('password123', gen_salt('bf')), 'MinChul_Kwak', 180.0, 77.0, 30, 'male', 'USER'),
('user030@example.com', crypt('password123', gen_salt('bf')), 'SuBin_Seok', 168.0, 58.0, 26, 'female', 'USER'),
('user031@example.com', crypt('password123', gen_salt('bf')), 'WooJin_Sunwoo', 176.0, 72.0, 28, 'male', 'USER'),
('user032@example.com', crypt('password123', gen_salt('bf')), 'BoRa_Ahn', 161.0, 51.0, 22, 'female', 'USER'),
('user033@example.com', crypt('password123', gen_salt('bf')), 'JaeMin_Ok', 179.0, 76.0, 29, 'male', 'USER'),
('user034@example.com', crypt('password123', gen_salt('bf')), 'SoHee_Yook', 166.0, 56.0, 25, 'female', 'USER'),
('user035@example.com', crypt('password123', gen_salt('bf')), 'HyunSeok_In', 174.0, 69.0, 27, 'male', 'USER'),
('user036@example.com', crypt('password123', gen_salt('bf')), 'ChaeYoung_Lim', 163.0, 53.0, 24, 'female', 'USER'),
('user037@example.com', crypt('password123', gen_salt('bf')), 'WooJin_Jang', 181.0, 79.0, 31, 'male', 'USER'),
('user038@example.com', crypt('password123', gen_salt('bf')), 'DaYoung_Jun', 169.0, 59.0, 26, 'female', 'USER'),
('user039@example.com', crypt('password123', gen_salt('bf')), 'SeungHyun_Jung', 177.0, 73.0, 28, 'male', 'USER'),
('user040@example.com', crypt('password123', gen_salt('bf')), 'ARa_Jo', 165.0, 55.0, 25, 'female', 'USER'),
('user041@example.com', crypt('password123', gen_salt('bf')), 'TaeYang_Jin', 172.0, 68.0, 26, 'male', 'USER'),
('user042@example.com', crypt('password123', gen_salt('bf')), 'YeEun_Cha', 162.0, 52.0, 23, 'female', 'USER'),
('user043@example.com', crypt('password123', gen_salt('bf')), 'HyungJun_Choi', 178.0, 74.0, 27, 'male', 'USER'),
('user044@example.com', crypt('password123', gen_salt('bf')), 'JiWoo_Tak', 167.0, 57.0, 24, 'female', 'USER'),
('user045@example.com', crypt('password123', gen_salt('bf')), 'MinSoo_Pyo', 175.0, 70.0, 25, 'male', 'USER'),
('user046@example.com', crypt('password123', gen_salt('bf')), 'JiYeon_Han', 164.0, 54.0, 26, 'female', 'USER'),
('user047@example.com', crypt('password123', gen_salt('bf')), 'JunHyuk_Hyun', 180.0, 76.0, 29, 'male', 'USER'),
('user048@example.com', crypt('password123', gen_salt('bf')), 'DaIn_Hong', 168.0, 58.0, 27, 'female', 'USER'),
('user049@example.com', crypt('password123', gen_salt('bf')), 'JaeWook_Hwang', 176.0, 71.0, 28, 'male', 'USER');
